...
*   Programación de UBU.
*
* AUTOR : Rodrigo Díaz         START DATE : 11 Mar 2017
*
* CAMBIOS:
...
int main(){
  ...
  printf("Insertar coordenadas del segundo punto (x,y,z) separated por comas: ");
...
long Apartado3(){
  ...
  scanf("%d %d %d,%d", &milliones, &miles, &unidades, &centimos);
